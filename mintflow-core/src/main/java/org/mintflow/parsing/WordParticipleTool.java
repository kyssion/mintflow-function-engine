...
import org.mintflow.exception.UserMintFlowRuntimeException;
import org.mintflow.parsing.mark.KeyworkItem;
import org.mintflow.parsing.mark.SymbolItem;
...
public class WordParticipleTool {
    ...
    public static List<Word> createWordParticipleListByFile(String path) throws Exception {
        ...
        if (fileStream == null) {
            throw new UserMintFlowRuntimeException("没有找到文件："+path);
        }
